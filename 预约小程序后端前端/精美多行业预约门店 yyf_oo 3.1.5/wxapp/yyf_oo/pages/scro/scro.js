...
Page({
    ...
    loadData: function(a) {
        var e = this;
        t.util.footer(e);
        var i = t.siteInfo.uniacid, d = e.data.tid, r = e.data.fid, s = (wx.getStorageSync("openid"), 
        e.data.windowWidth);
        t.util.request({
            ...
            success: function(t) {
                if (!t.data.errno) {
                    ...
                    e.setData({
                        ...
                        thumb_width: t.data.data.thumb_width,
                    ...
                    if (e.data.currentCatId != r && (console.log(e.data.currentCatId + "---" + r), e.setData({
                        list: [],
                        currentCatId: r
                    })), d > 0) {
